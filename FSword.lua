--uses: https://www.roblox.com/catalog/7548993875/Slasher
...
hat('Back_AccAccessory','Right Arm',CFrame.new(0,0,0),CFrame.new(0.5+0*math["cos"](sine/10),2+0*math["cos"](sine/10),-0.5+0*math["cos"](sine/10))*CFrame.Angles(math.rad(-100+0*math["cos"](sine/10)),math.rad(45+0*math["cos"](sine/10)),math.rad(90+0*math["cos"](sine/10))),false)
...
hat('Back_AccAccessory','Right Arm',CFrame.new(0,0,0),CFrame.new(0.5+0*math["cos"](sine/10),2+0*math["cos"](sine/10),-0.5+0*math["cos"](sine/10))*CFrame.Angles(math.rad(-100+0*math["cos"](sine/10)),math.rad(45+0*math["cos"](sine/10)),math.rad(90+0*math["cos"](sine/10))),false)
NECK.C0=NECK.C0:Lerp(CFrame.new(0+0*math.cos(sine/5),1+0*math.cos(sine/10),0+0*math.cos(sine/10))*CFrame.Angles(math.rad(10+0*math.cos(sine/5)),math.rad(0+5*math.cos(sine/5)),math.rad(0+0*math.cos(sine/5))),0.5) 
RJ.C0=RJ.C0:Lerp(CFrame.new(0+0*math.cos(sine/5),-1+0.1*math.sin(sine/5),0+0*math.cos(sine/10))*CFrame.Angles(math.rad(-15+2*math.cos(sine/5)),math.rad(0+0*math.cos(sine/5)),math.rad(0+5*math.cos(sine/10))),0.5) 
RS.C0=RS.C0:Lerp(CFrame.new(1+0*math.cos(sine/10),0.25+0*math.cos(sine/5),-0.5+0*math.cos(sine/10))*CFrame.Angles(math.rad(75+-5*math.cos(sine/5)),math.rad(15+0*math.cos(sine/10)),math.rad(0+0*math.cos(sine/10))),0.5) 
LS.C0=LS.C0:Lerp(CFrame.new(-0.5+0*math.cos(sine/10),0+-0.05*math.cos(sine/5),-0.75+0*math.cos(sine/10))*CFrame.Angles(math.rad(88.4+-5*math.cos(sine/5)),math.rad(22.6+0*math.cos(sine/10)),math.rad(38.3+0*math.cos(sine/10))),0.5) 
RH.C0=RH.C0:Lerp(CFrame.new(0.5+0*math.cos(sine/10),-1+-0.3*math.sin(sine/10),0+-0.5*math.cos(sine/10))*CFrame.Angles(math.rad(15+60*math.cos(sine/10)),math.rad(0+-5*math.cos(sine/10)),math.rad(0+-5*math.cos(sine/10))),0.5) 
LH.C0=LH.C0:Lerp(CFrame.new(-0.5+0*math.cos(sine/10),-1+0.3*math.sin(sine/10),0+0.5*math.cos(sine/10))*CFrame.Angles(math.rad(15+-60*math.cos(sine/10)),math.rad(0+5*math.cos(sine/10)),math.rad(0+-5*math.cos(sine/10))),0.5)
...
hat('Back_AccAccessory','Right Arm',CFrame.new(0,0,0),CFrame.new(0.5+0*math["cos"](sine/10),2+0*math["cos"](sine/10),-0.5+0*math["cos"](sine/10))*CFrame.Angles(math.rad(-100+0*math["cos"](sine/10)),math.rad(45+0*math["cos"](sine/10)),math.rad(90+0*math["cos"](sine/10))),false)
NECK.C0=NECK.C0:Lerp(CFrame.new(0+0*math.cos(sine/10),1+0*math.cos(sine/10),0+0*math.cos(sine/10))*CFrame.Angles(math.rad(-10+0*math.cos(sine/10)),math.rad(0+0*math.cos(sine/10)),math.rad(0+0*math.cos(sine/10))),0.5) 
RJ.C0=RJ.C0:Lerp(CFrame.new(0+0*math.cos(sine/10),-1+0.05*math.sin(sine/50),0+0*math.cos(sine/10))*CFrame.Angles(math.rad(10+0*math.cos(sine/50)),math.rad(0+-1*math.cos(sine/50)),math.rad(0+-1*math.cos(sine/50))),0.5) 
RS.C0=RS.C0:Lerp(CFrame.new(1.5+0.1*math.cos(sine/50),0+0.05*math.sin(sine/50),0.25+0*math.cos(sine/10))*CFrame.Angles(math.rad(-121.4+0*math.cos(sine/50)),math.rad(90+-4*math.cos(sine/50)),math.rad(-30+0*math.cos(sine/50))),0.5) 
LS.C0=LS.C0:Lerp(CFrame.new(-1.5+0*math.cos(sine/10),0.5+0*math.cos(sine/10),0+0*math.cos(sine/10))*CFrame.Angles(math.rad(-10+0*math.cos(sine/10)),math.rad(0+0*math.cos(sine/10)),math.rad(0+0*math.cos(sine/10))),0.5) 
RH.C0=RH.C0:Lerp(CFrame.new(0.5+0*math.cos(sine/10),-1+-0.05*math.sin(sine/50),0+0*math.cos(sine/10))*CFrame.Angles(math.rad(-10+0*math.cos(sine/50)),math.rad(-15+1*math.cos(sine/10)),math.rad(0+1*math.cos(sine/50))),0.5) 
LH.C0=LH.C0:Lerp(CFrame.new(-0.5+0*math.cos(sine/10),-1+-0.05*math.sin(sine/50),0+0*math.cos(sine/10))*CFrame.Angles(math.rad(-10+0*math.cos(sine/50)),math.rad(15+1*math.cos(sine/10)),math.rad(0+1*math.cos(sine/50))),0.5)
